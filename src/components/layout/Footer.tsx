        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/landing.html" className="text-primary-foreground/70 hover:text-secondary transition-colors">
                  Static Portal
                </a>
              </li>
              <li>
                <a href="/info.html" className="text-primary-foreground/70 hover:text-secondary transition-colors">
                  Portal Help & FAQ
                </a>
              </li>
            </ul>
