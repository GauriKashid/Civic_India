...
export default function ReportNow() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (formData.latitude) uploadData.append('latitude', String(formData.latitude));
      if (formData.longitude) uploadData.append('longitude', String(formData.longitude));
      if (formData.severity) uploadData.append('severity', formData.severity);
